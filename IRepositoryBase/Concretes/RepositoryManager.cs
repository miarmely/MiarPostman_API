...
namespace Repositories.Concrete
{
    public class RepositoryManager : IRepositoryManager
    {
        ...
        private readonly Lazy<IBossRepository> _bossRepository;
        ...
        public IBossRepository Boss => _bossRepository.Value;
        ...
        public RepositoryManager(RepositoryContext context)
        {
            ...
            _managerRepository = new Lazy<IManagerRepository>(() => new ManagerRepository(_context));
            ...
            _bossRepository = new Lazy<IBossRepository>(() => new BossRepository(_context));
        }
